...
abstract class DigitalAccount extends Model
{
     ...
     */
    public function __construct(string $type, string $name, string $document, string $email, string $phone, string $businessArea, string $linesOfBusiness, Address $address, BankAccount $bankAccount, float $monthlyIncomeOrRevenue, $pep = false, bool $emailOptOut = false, bool $autoTransfer = false)
    {
        $this->type = $type;
        $this->name = $name;
