...
Route::post('/notification/juno/digital-accounts/{nickname}/transfer/', [DigitalAccountController::class, 'transferStatusChanged'])->name('notifications.juno.transferStatusChanged');
Route::post('/notification/juno/digital-accounts/{nickname}/p2p-transfer/', [DigitalAccountController::class, 'p2pTransferStatusChanged'])->name('notifications.juno.p2pTransferStatusChanged');
